...
public class ScriptableMonoObject : SerializedScriptableObject, ICacheable, ISerializationCallbackReceiver
{
        ...
        OverwriteMode overwriteMode = OverwriteMode.Increment, string path = null)
    {
        ...
        {
            overwriteMode = EditorUtility.DisplayDialog("Overwrite existing asset?",
                $"An asset already exists at {assetPath}. Overwrite it?",
                "Yes",
                "No")
        ...
        SerializedObject serializedObject = new(createdAsset);
